...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（斬撃） | 8 | 3m | 5 | 片手 | 10 tick | 5 |
| 特殊（旋空） | 8 | 6m | 5 | 片手 | 10 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（前方斬撃） | 6 | 2m | 5 | 片手 | 8 tick | 4 |
| 特殊（全方位） | 6 | 2m（360°） | 5 | 片手 | 8 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（剣/盾） | 5（剣）/—（盾・35%軽減） | 2m（剣）/— | 5 | 片手 | 12 tick | 6 |
| 特殊（モード切替） | — | — | 5 | 片手 | 12 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（射撃） | 5 | 50m | 4 | 片手 | 12 tick | 4 |
| 特殊（3連射） | 3.5×3発 | 50m | 4 | 片手 | 12 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（射撃） | 5 | 100m | 5 | 両手 | 8 tick | 6 |
| 特殊（5連射） | 3/発×5発 | 100m | 5 | 両手 | 8 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（散弾） | 7×6発（最大42） | 20m | 6 | 両手 | 20 tick | 6 |
| 特殊（集中射撃） | 10.5×6発（最大63） | 20m | 6 | 両手 | 20 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（射撃） | 6 | 80m | 10 | 両手 | 4 tick | 10 |
| 特殊（8連射） | 3×8発 | 80m | 10 | 両手 | 4 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（放物弾） | 10（範囲4m） | 50m | 9 | 両手 | 30 tick | 8 |
| 特殊（高速爆発弾） | 12（範囲6m） | 50m | 9 | 両手 | 30 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（一斉発射） | 7/発（最大×6） | 40m | 0 | 片手 | 15 tick | 6 |
| 特殊（弾設置） | — | 前方4m | 5/発 | 片手 | 5 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（爆発弾） | 9（範囲3m） | 30m | 8 | 片手 | 20 tick | 7 |
| 特殊（高速爆発弾） | 9（範囲4.5m） | 30m | 8 | 片手 | 20 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（追尾弾） | 5 | 40m | 5 | 片手 | 15 tick | 6 |
| 特殊（3連追尾） | 5×3発 | 40m | 5 | 片手 | 15 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（操舵弾） | 6 | 35m | 7 | 片手 | 20 tick | 8 |
| 特殊（縦3連操舵） | 6×3発 | 35m | 7 | 片手 | 20 tick | — |

**概要**：発射後にマウス操作で軌道を操作できる変則弾トリガー。弾速は遅いが自在に曲げられる。

**通常発動**：操舵弾1発（発射後、向いた方向に弾が追従して曲がる）

**特殊発動**：縦方向3発同時発射（それぞれ独立して操舵可能）
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（Slowness弾） | 0（Slowness III） | 25m | 8 | 片手 | 20 tick | 7 |
| 特殊（範囲Slowness） | 0（範囲3m・Slowness III） | 25m | 8 | 片手 | 20 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（速射） | 8 | 300m | 7 | 両手 | 40 tick | 8 |
| 特殊（チャージ） | 20（威力×2.5） | 300m | 7 | 両手 | 40 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（高速弾） | 5 | 200m | 6 | 両手 | 35 tick | 7 |
| 特殊（5連射） | 5×5発 | 200m | 6 | 両手 | 35 tick | — |
...
| 発動 | 威力 | 射程 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|---|
| 通常（高威力弾） | 45（威力×3） | 400m | 9 | 両手 | 50 tick | 10 |
| 特殊（爆破弾） | 30（威力×2）＋爆発 | 400m | 9 | 両手 | 50 tick | — |
...
| 発動 | ダメージ軽減率 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|
| 通常（バリア） | 50%（3秒） | 3 | 片手 | — | 3 |
| 特殊（集中） | 75%（1.5秒） | 3 | 片手 | — | — |
...
| 機能 | 消費トリオン | クールダウン | 装備コスト |
|---|---|---|---|
| ON/OFFトグル（レーダー非表示） | 2/秒（継続） | — | 3 |
...
| 発動 | 消費トリオン | クールダウン | 装備コスト |
|---|---|---|---|
| 通常（ワイヤー弾・単体Slowness） | 4 | — | 4 |
| 特殊（ワイヤー網・周囲全体Slowness） | 4 | — | — |
...
| 発動 | 威力 | 消費トリオン | 両手/片手 | クールダウン | 装備コスト |
|---|---|---|---|---|---|
| 通常（選択モード弾発射） | 7（範囲3m） | 10 | 片手 | 20 tick | 12 |
| 特殊（ラジアルメニュー） | — | — | 片手 | — | — |
